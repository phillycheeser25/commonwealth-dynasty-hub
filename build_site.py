...
articles = [
    ...
    },
    {
        ...
        "dek": "The rivalry arrives with ACC title math, CFP pressure, quarterback star power, and a whole state waiting to talk.",
        "author": "Commonwealth Wire Staff",
        "location": "Blacksburg, VA",
        "year": 2028,
        "week": 13,
...
def home():
    body = f"""
      <section class="hero-layout">
        <a class="hero-card" href="articles/{articles[0]['slug']}/">
          <img src="week12-hero.png" alt="Virginia Tech 49 Wake Forest 7">
          <span class="hero-copy">
            <span class="kicker">Top Story</span>
            <span class="hero-title">{esc(articles[0]['title'])}</span>
            <span class="hero-dek">{esc(articles[0]['dek'])}</span>
            <span class="byline">Commonwealth Wire Staff | Week 12</span>
          </span>
        </a>
